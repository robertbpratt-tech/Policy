...
**Last refreshed:** April 28, 2026 post-2.14 v2.0 commit (entry 38 — Phase 5C). 2.14 D v1.0 → T v2.0 (commit `4556509b`; closed #99, #101, #102, #229, #332). Three validator rounds; all R3 architectural re-pushes declined; new standing decline #37 promoted (inline §4 enforcement enumeration, 3-round confirmed rotation). Companion edit 2.04 v2.6 → v2.7 (commit `34e8edf1`; CJC certificate-auth inactivity-exemption sub-bullet stripped — location predicate unenforceable; cert-auth VPN sits outside AC-12 password-session timeout architecture by virtue of `authenticating via password` qualifier preserved in parent directive). Ticket #470 filed and closed documenting the strike rationale and adjudication trail. CSO-exception Constraint strip Chapter 2 sweep complete (2.14 was the final pending). #467 manual-wide trailing-colon sweep absorbed for 2.14 (5/178 titles compliant). Pattern #36 cumulative manual-wide rotation count: 7 (2.09 R1/R2/R3/R4 origin + 2.14 R1/R2/R3). Prior archive #465 covered entry 34 (2.07 v2.2).

**Phase 5C in progress.** Phase 5B closed (LASO Priority Group entries 25–31); Phase 5C entries 32–38 complete (2.03 v2.0, 2.05 v2.2, 2.07 v2.2, 2.08 v2.0, 2.09 v2.0, 2.10 v2.3, 2.14 v2.0). Recalc marker after entry 39 (end of 5C). **Next session: entry 39 — 2.15 (Secure Software Lifecycle).** 2.15 open tickets: #103, #104, #105 (3 tickets); lowest dependency policy and natural Chapter 2 closer.
