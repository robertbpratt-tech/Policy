...
| 4.07 | Postmortem and Lessons Learned | T | v2.2 | 0 | — | v2.1 (April 12, 2026): IC block merged into IT Dir with 4.01 §6.1 designee clarifier + non-transfer. #208 resolved. 1.08→5.01 §6.6. §4 Enforcement sub-bullets + non-waivable floor. §5 CR/FA split rebuilt. §6.7 pipeline fix + 3.06 §6.8 acknowledgment (#259). Product names removed (#6). #304 gate passed (final Ch4). v2.2: §6.2 SoD added to non-waivable floor (ChatGPT accept); "as applicable"→"when the IT Director determines distribution is warranted" (Gemini partial accept). Closed #179, #259, #304. No ripple issues filed. One cross-validator round (Gemini + ChatGPT). |
...
13. **~~4.07 (Postmortem and Lessons Learned)~~** — ✅ **Complete (v2.2, April 13, 2026).** v2.1: IC block merged into IT Dir with 4.01 §6.1 designee clarifier + non-transfer Constraint. #208 resolved. 1.08→5.01 §6.6. §4 Enforcement sub-bullets + non-waivable floor. §5 CR/FA rebuilt. §6.7 pipeline fix + 3.06 §6.8 acknowledgment (#259). Product names removed (#6). §6.2 prohibited term fixed. #304 Ch4 gate complete. v2.2: §6.2 SoD added to non-waivable floor (ChatGPT accept); "as applicable"→objective trigger (Gemini partial accept). Closed #179, #259, #304. No ripple issues. One cross-validator round (Gemini + ChatGPT): ChatGPT 1/2 accepted (SoD non-waivable), 1/2 declined (restore IC block — settled Ch4 pattern); Gemini 1/9 partially accepted ("as applicable"), 8/9 declined (ordering false positive, prohibited term false positive, body citation false positive, §2 parenthetical exempt, IR-8 directive violates anti-parallel clause, Problem cap already compliant, LRDA note only).
