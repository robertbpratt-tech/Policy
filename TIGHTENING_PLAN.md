...
| 4.07 | Postmortem and Lessons Learned | T | v2.3 | 0 | — | v2.1 (April 12): IC block merged; #208; 1.08→5.01 §6.6; §4 rebuilt; §5 rebuilt; §6.7 pipeline fix+3.06 §6.8 ack; product names removed. v2.2 (April 13): §6.2 SoD added to non-waivable floor (ChatGPT R1); "as applicable"→objective (Gemini R1). v2.3 (April 13): §3 Constraint→Shall-opening directive (ChatGPT R2 C6); §3 attendance "when directed"→"unless excused" aligned with §6.3 (ChatGPT R2 C5). Closed #179, #259, #304. No ripple issues filed. Two cross-validator rounds. |
...
13. **~~4.07 (Postmortem and Lessons Learned)~~** — ✅ **Complete (v2.3, April 13, 2026).** v2.1: IC block merged into IT Dir with 4.01 §6.1 designee clarifier + non-transfer. #208 resolved. 1.08→5.01 §6.6. §4 Enforcement sub-bullets + non-waivable floor. §5 CR/FA rebuilt. §6.7 pipeline fix + 3.06 §6.8 acknowledgment (#259). Product names removed (#6). §6.2 prohibited term fixed. #304 Ch4 gate complete. v2.2: §6.2 SoD added to non-waivable floor (ChatGPT R1); "as applicable"→objective trigger (Gemini R1). v2.3: §3 Constraint tag converted to Shall-opening directive (ChatGPT R2 C6); §3 attendance "when directed"→"unless excused" aligned with §6.3 (ChatGPT R2 C5). Closed #179, #259, #304. No ripple issues. Two cross-validator rounds: R1 ChatGPT 1/2 accepted (SoD non-waivable), Gemini 1/9 partial ("as applicable"); R2 ChatGPT 2/6 accepted (attendance alignment, Constraint→Shall), Gemini 0/3 declined.
