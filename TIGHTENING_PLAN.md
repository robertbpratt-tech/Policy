...
**Last refreshed:** April 28, 2026 post-2.10 v2.3 commit (entry 37 — Phase 5C). 2.10 D v1.0 → T v2.3 (commit `a93302b9`; closed #88, #89, #90, #226). Three validator rounds; CM-7(1) Periodic Review directive added per ChatGPT R2 catch (genuine substantive gap, not a stylistic finding); §6.3 positive-directive inversion applied per ticket #469 framing; §6.4 enumerated credential list dropped per Robert's weasel-room concern (interpreted-as-exhaustive risk on enumerated lists); §6.7 reduced to single report directive in R3 ("let 3.06 carry its own weight"); 4.04 cleanly demoted out of §5 since no longer body-cited. Standing decline #36 confirmed at rotation 7 cumulative (R1/R2/R3 all hit the same architectural target with rotating surface framing; no §4 modification needed — pattern already canonical). Watch items not yet promoted: ChatGPT §6.4 list-expansion at rotation 2 (R2/R3); Gemini "(as LASO)" header objection at rotation 1 (R3, Pattern #14 stale source). Prior archive #465 covered entry 34 (2.07 v2.2).

**Phase 5C in progress.** Phase 5B closed (LASO Priority Group entries 25–31); Phase 5C entries 32–37 complete (2.03 v2.0, 2.05 v2.2, 2.07 v2.2, 2.08 v2.0, 2.09 v2.0, 2.10 v2.3). Recalc marker after entry 39 (end of 5C). **Next session: entry 38 — 2.14 (Mobile/Remote Access).** 2.14 open tickets: #99, #101, #102, #229, #332 (5 tickets); product name removal (#7/#99 Office 365) is the structural marker.
...
**CSO-exception Constraint strip — pending #425 reframe (5.01 §6.6 clarifier):** One untightened Chapter 2 policy carries blanket "CJI-involving exceptions require CSO approval" language in its §4 Exceptions block: **2.14.** Ruling during 2.12 v2.3 session (April 23, 2026) established this pattern reflects CJIS-adjacent formality rather than operational workflow. Strip the blanket Constraint sub-bullet during the policy's tightening session; standard 5.01 §6.6 exception framework governs. Stripped during tightening: 2.05 v2.2, 2.07 v2.2, 2.08 v2.0, 2.09 v2.0, 2.10 v2.3. Does NOT touch genuine CJIS-control-specific CSO clauses (CJIS IR-6 Part (b), PS-3 delegation, AC-7 authorization) in 1.11, 1.13, 1.14, 2.02, 2.04, 4.01, 4.02, 4.05, 4.06, 5.01.
