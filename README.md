...
| `01/104.lyx` | Policy and Documentation Formatting Standards | T+ | v1.5 | #494, #498, #506, #509 |
| `01/105.lyx` | Policy Review and Update Procedures | T+ | v2.3 | #495, #502, #508, #509 |
| `01/106.lyx` | IT Governance and Oversight Structure | T+ | v2.2 | #491, #497, #502, #509 |
| `01/107.lyx` | Workforce Roles, Responsibilities, and Competency Framework | T+ | v1.4 | #354, #495, #509 |
| `01/108.lyx` | Delegation of Authority and Decision Rights | T+ | v1.6 | #491, #495, #497, #503, #509 |
| `01/109.lyx` | Risk Management Policy | T+ | v2.2 | #491, #497, #502 |
| `01/110.lyx` | IT Financial Management and Procurement Policy | T+ | v2.3 | #488, #508 |
| `01/111.lyx` | Data Governance and Classification Policy | T+ | v2.5 | #484, #488, #495, #502, #509 |
| `01/112.lyx` | IT Asset Management Policy | T+ | v2.7 | #329, #426, #487, #509 |
| `01/113.lyx` | Supply Chain Risk Management (SCRM) and Vendor Governance | T+ | v2.4 | #484, #486, #492, #495, #509 |
| `01/114.lyx` | Stakeholder Engagement and Communications Policy | T+ | v2.4 | #491, #495, #499, #500 |

## Chapter 2 — Security

| File | Title | Status | Version | Tickets |
| --- | --- | --- | --- | --- |
| `02/201.lyx` | Acceptable Use of Information Technology Resources Policy | T+ | v2.6 | #356, #486, #495, #507, #509 |
...
| `02/204.lyx` | Access Control Policy | T+ | v2.8 | #453, #495, #502, #509 |
| `02/205.lyx` | Identification and Authentication Policy | T+ | v2.3 | #495, #507 |
| `02/206.lyx` | Privacy and Data Protection Policy | T+ | v2.8 | #486, #495 |
...
| `02/211.lyx` | Audit Logging and Monitoring Policy | T+ | v2.5 | #495, #497, #500, #502, #503, #507, #509 |
| `02/212.lyx` | Media Protection and Sanitization Policy | T+ | v2.5 | #449, #497, #500, #503, #507 |
...
| File | Title | Status | Version | Tickets |
| --- | --- | --- | --- | --- |
| `03/301.lyx` | Service Catalog and SLA Policy | T+ | v2.5 | #495, #497, #500 |
| `03/302.lyx` | Service Level Management and Metrics Reporting | T+ | v2.6 | #309, #486, #500, #509 |
...
| `03/305.lyx` | Service Request Fulfillment Policy | T+ | v2.2 | #492, #500, #509 |
| `03/306.lyx` | Operational Incident Management Policy | T+ | v2.2 | #450, #492, #498, #500 |
| `03/307.lyx` | Problem Management Policy | T+ | v2.4 | #487, #491, #492, #500, #509 |
| `03/308.lyx` | Service Configuration Management (CMDB) Policy | T+ | v2.3 | #461, #488, #490, #492, #500, #509 |
| `03/309.lyx` | Change Management Policy | T+ | v2.1 | #490, #492, #495, #498, #509 |
...
| `03/312.lyx` | Monitoring and Event Management Policy | T+ | v2.1 | #413, #495, #500 |
| `03/313.lyx` | Knowledge Management Policy | T+ | v2.3 | #485, #488, #492, #495, #500, #509 |
| `03/314.lyx` | IT Project Management Policy | T+ | v2.3 | #478, #484, #492, #495, #509 |
...
| File | Title | Status | Version | Tickets |
| --- | --- | --- | --- | --- |
| `04/401.lyx` | Incident Response Policy Overview | T+ | v2.1 | #418, #457, #477, #486, #498, #500 |
| `04/402.lyx` | Identification and Reporting Procedures | T+ | v2.2 | #492, #495, #498, #499, #500 |
| `04/403.lyx` | Containment Strategy and Playbooks | T+ | v2.2 | #495, #498, #500, #501, #504, #509 |
| `04/404.lyx` | Eradication Procedures and Scenario Guides | T+ | v2.4 | #485, #492, #495, #498, #500 |
| `04/405.lyx` | Recovery Operations and Restoration Prioritization | T+ | v2.4 | #458, #477, #485, #492, #495, #497, #498, #500, #504 |
| `04/406.lyx` | Communication Protocols and Partner Integration | T+ | v2.3 | #378, #492, #498, #499, #500 |
| `04/407.lyx` | Postmortem Review and Lessons Learned | T+ | v1.1 | #477, #478, #492, #498, #500, #502, #504 |

## Chapter 5 — Compliance

| File | Title | Status | Version | Tickets |
| --- | --- | --- | --- | --- |
| `05/501.lyx` | Policy Implementation, Enforcement, and Legal Alignment | T+ | v2.0 | #495, #497 |
...
| `05/505.lyx` | Security Control Assessment and Authorization | T | v2.0 |  |
| `05/506.lyx` | Vendor Compliance and Third-Party Assurance | D | v1.0 | #281, #331, #486, #489, #492, #509 |
