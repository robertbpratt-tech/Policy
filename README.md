...
| `01/108.lyx` | Delegation of Authority and Decision Rights | T+ | v1.6 | #491, #495, #497 |
| `01/109.lyx` | Risk Management Policy | T+ | v2.2 | #491, #497 |
| `01/110.lyx` | IT Financial Management and Procurement Policy | T+ | v2.3 | #488 |
| `01/111.lyx` | Data Governance and Classification Policy | T+ | v2.5 | #484, #488, #493, #495 |
| `01/112.lyx` | IT Asset Management Policy | T+ | v2.7 | #329, #426, #487 |
| `01/113.lyx` | Supply Chain Risk Management (SCRM) and Vendor Governance | T+ | v2.4 | #484, #486, #492, #495 |
| `01/114.lyx` | Stakeholder Engagement and Communications Policy | T+ | v2.4 | #491, #495 |

## Chapter 2 — Security

| File | Title | Status | Version | Tickets |
| --- | --- | --- | --- | --- |
| `02/201.lyx` | Acceptable Use of Information Technology Resources Policy | T+ | v2.6 | #356, #486, #495 |
| `02/202.lyx` | Personnel Security and Background Screening Policy | T+ | v2.8 | #487, #495 |
| `02/203.lyx` | Security Awareness and Training Policy | T | v2.2 | — |
| `02/204.lyx` | Access Control Policy | T+ | v2.8 | #453, #493, #495 |
| `02/205.lyx` | Identification and Authentication Policy | T+ | v2.3 | #495 |
| `02/206.lyx` | Privacy and Data Protection Policy | T+ | v2.8 | #486, #495 |
| `02/207.lyx` | System and Communications Protection Policy | T+ | v2.3 | #495 |
...
| `02/211.lyx` | Audit Logging and Monitoring Policy | T+ | v2.5 | #493, #495, #497 |
| `02/212.lyx` | Media Protection and Sanitization Policy | T+ | v2.5 | #449, #497 |
| `02/213.lyx` | Physical Security and Environmental Controls Policy | T+ | v2.4 | #497 |
...
| File | Title | Status | Version | Tickets |
| --- | --- | --- | --- | --- |
| `03/301.lyx` | Service Catalog and SLA Policy | T+ | v2.5 | #495, #497 |
...
| `03/313.lyx` | Knowledge Management Policy | T+ | v2.3 | #485, #488, #492, #495 |
| `03/314.lyx` | IT Project Management Policy | T+ | v2.3 | #478, #484, #492, #493, #495 |
| `03/315.lyx` | Service Continuity and Contingency Planning Policy | T+ | v2.3 | #314, #492, #496 |
| `03/316.lyx` | Service Improvement and Continual Improvement Plan | T+ | v2.1 | #452 |
| `03/317.lyx` | System Maintenance and Vendor Repairs | T+ | v2.2 | #489, #492, #495 |
...
| `05/506.lyx` | Vendor Compliance and Third-Party Assurance | D | v1.0 | #281, #331, #486, #489, #492 |
